  ...
  return (
    <div className="flex flex-col items-center">
      <div className="flex space-x-4 items-center">
        <div className="flex items-center bg-white rounded-md w-[70vh] h-10 px-4 py-5 ring-1  hover:shadow-lg hover:shadow-blue-200 ring-gray-400 hover:ring-secondPrimary  ">
          <input
      ...
      {status != null ? (
        status === 'success' ? (
          <div className="flex flex-col mt-6 space-y-3 items-center">
            <p className="text-lg font-mono text-gray-600">Thank you for your feedback</p>
            <BsFillEmojiSmileFill className="text-orange-600 text-xl" />
          </div>
        ) : status === 'empty' ? (
          <div className="flex flex-col mt-6 space-y-3 items-center">
            <p className="text-lg font-mono text-gray-600">Empty field</p>
            <ImSad2 className="text-red-700 text-xl" />
          </div>
        ) : (
          <div className="flex flex-col mt-6 space-y-3 items-center">
            <p className="text-lg font-mono text-gray-600">Failed</p>
            <ImSad2 className="text-red-700 text-xl" />
          </div>
        )
      ) : (
